...
data1 = teljes_adat[:25]
print(f"RAGAS mérés 1/2 (1-{len(data1)} kérdések)...")
ds1 = Dataset.from_list(data1)
score1 = evaluate(
    ds1,
...
print("\nAz első 25 részeredménye:")
print(score1)

score1.to_pandas().to_csv("ragas_1_resz.csv", index=False)
